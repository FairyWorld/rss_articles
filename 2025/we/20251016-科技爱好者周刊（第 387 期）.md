...
2026年2月，世界总人口81亿，如果画成一个[方块图](https://www.reddit.com/r/vibecoding/comments/1rbqldk/youre_early/)，每个方块代表320万人。

![](https://cdn.beekka.com/blogimg/asset/202602/bg2026022615.webp)

从没用过 AI 的人（灰色方块）有68.8亿（84%）。

只用过 AI 免费对话的人（绿色方块）有13.8亿（16%）。

付费订阅 AI 服务的人（黄色方块）大约1500万～2500万（0.3%）。

使用 AI 生成完整代码或代码主体的人（红色方块）大约200万～500万（0.04%）。
